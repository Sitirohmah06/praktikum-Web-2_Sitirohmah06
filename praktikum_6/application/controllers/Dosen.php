...
class Dosen extends CI_Controller
{
    public function index()
    {
        ...
        $this->dsn3->id = 4;
        $this->dsn3->nama = 'Aneisha';
        $this->dsn3->nidn = '02105';
        $this->dsn3->gender = 'Perempuan';
        $this->dsn3->tmp_lahir = 'Lampung';
        $this->dsn3->tgl_lahir = '02-10-1994';
        $this->dsn3->pendidikan = 'S1 Kebidanan';
